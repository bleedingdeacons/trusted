...
/**
 * Build Script for Trusted WordPress Plugin
 *
...
class PluginBuilder
{
    ...
    private string $pluginName = 'trusted';
    private string $mainFile = 'trusted.php';
    private string $versionConstant = 'TRUSTED_VERSION';
...
Trusted WordPress Plugin Build Script
====================================
Platform: {$platform}
